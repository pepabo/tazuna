...
// TestStateDrift_SkipParallel は parallel manifest がスキップされ警告ログが出ることを縛る。
func TestStateDrift_SkipParallel(t *testing.T) {
	t.Parallel()
	...
	assert.Contains(t, logBuf.String(), "parallel manifest is not supported for state drift",
